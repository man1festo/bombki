...
?>
<div class="col-sm-8 shop__catalog__items">
	<div class="row">
<div class="catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	...
	if (!empty($arResult['ITEMS']) )
	{
		...
		foreach ($arResult['ITEMS'] as $item)
		{
			...
			?><script>
				console.log(<?=CUtil::PhpToJSObject($item, false, true)?>);
				</script>
			<div class="col-md-4 col-xs-6 shop__catalog__item play"><img class="img-responsive" src="<?=$item['PREVIEW_PICTURE']['SRC']?>" alt="">
